...
_EN = {
    ...
    "repl.auth.usage": "usage: /auth <status|login|logout> <claude|codex|gemini>",
    ...
    "slash.desc.auth": "official fixed-argv authentication actions",
...
_KO = {
    ...
    "repl.auth.usage": "사용법: /auth <status|login|logout> <claude|codex|gemini>",
    ...
    "slash.desc.auth": "공식 고정 인자 인증 작업",
